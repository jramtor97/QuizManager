...
<div class="row">
        ...
        <ul>
          <li>Número de participantes: <?php 
            ...
            // SELECT COUNT(*) FROM (SELECT distinct r.puntuacion_final FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
            //     WHERE r.id_proyecto = 1
            //     AND r.id_proyecto = r1.id_proyecto) p;
            $sql = "SELECT DISTINCT COUNT(r.id_proyecto) AS NUM_PART FROM respuestas_smil r, rec r1 WHERE r.id_proyecto = ".$_REQUEST['id']." AND r.id_proyecto = r1.id_proyecto ";
        ...
        ?></li>
          <li>Promedio de edad: <?php 
            ...
            $sql = "SELECT ROUND(AVG(p.edad),0) AS NUM_PART FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
        ...
        ?></li>
          <ul>
            ...
            $sql = "SELECT MAX(p.edad) AS NUM_PART FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si' ";
        ...
        ?></li>
            ...
            $sql = "SELECT MIN(p.edad) AS NUM_PART FROM  respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si' ";
        ...
        ?></li>
          ...
          <ul>
            ...
            $sql = "SELECT ROUND((COUNT(p.sexo)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS NUM_PART FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
        ...
        ?> %</li>
          ...
          <ul>
            <li>Muy alto: <?php 
              ...
              $sql = "SELECT ROUND((COUNT(p.exp_internet)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS NUM_PART FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
        ...
        ?> %</li>
          ...
          <ul>
            <li>Muy alto: <?php 
              ...
              $sql = "SELECT ROUND((COUNT(p.exp_sistemas)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS NUM_PART FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
        ...
        <h5><strong>Puntuación cuestionario: </strong></h5>
          ...
          <li>Promedio de resultados: <?php 
            ...
            $sql = "SELECT ROUND(AVG(r.puntuacion_final),2) AS NUM_PART FROM respuestas_smil r, rec r1 WHERE r.id_proyecto = ".$_REQUEST['id']." AND r.id_proyecto = r1.id_proyecto";
...
<?php
            ...
            $sql = "SELECT r.url_usuario, r.puntuacion_final FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";
            ...
            $sql_w = "SELECT COUNT(r.puntuacion_final) AS COUNTT FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";
            ...
            $sql_q = "SELECT COUNT(r.url_usuario) AS COUNT FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";
...
<?php
            ...
            $sql_excelente = "SELECT ROUND((COUNT(r.puntuacion_final)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS EXCELENTE FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
              ...
              $sql_bueno = "SELECT ROUND((COUNT(r.puntuacion_final)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS BUENO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
              ...
              $sql_bien = "SELECT ROUND((COUNT(r.puntuacion_final)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS BIEN FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
              ...
              $sql_pobre = "SELECT ROUND((COUNT(r.puntuacion_final)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS POBRE FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
              ...
              $sql_mediocre = "SELECT ROUND((COUNT(r.puntuacion_final)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS MEDIOCRE FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var table = $('#example').DataTable({
            ...
            ajax: "ajax_tabla_resultados_smil.php?id="+'<?php echo $_REQUEST['id'] ?>',
            language: {
...
<?php
            ...
            $sql = "SELECT r.url_usuario, u.edad FROM respuestas_smil r, presentacion_usuario u WHERE
            ...
            $sql_q1 = "SELECT COUNT(r.url_usuario) AS COUNT FROM respuestas_smil r, presentacion_usuario u
...
<script type="text/javascript">
  ...
  <?php
            ...
            $sql = "SELECT ROUND((COUNT(p.sexo)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                ...
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS GRAFICA_MUJER FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
            ...
            $sql_q = "SELECT ROUND((COUNT(p.sexo)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS GRAFICA_HOMBRE FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
    ...
    <script type="text/javascript">
      <?php
              ...
              $sql = "SELECT ROUND((COUNT(p.exp_sistemas)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                ...
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS MUY_BAJO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
              ...
              $sql_b = "SELECT ROUND((COUNT(p.exp_sistemas)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS BAJO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
              ...
              $sqlm = "SELECT ROUND((COUNT(p.exp_sistemas)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS MEDIO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
              ...
              $sqla = "SELECT ROUND((COUNT(p.exp_sistemas)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS ALTO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
              ...
              $sqlaa = "SELECT ROUND((COUNT(p.exp_sistemas)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS MUY_ALTO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'
              ...
              $sqlmm = "SELECT ROUND((COUNT(p.exp_internet)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS MUY_BAJO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
              ...
              $sqlmmm = "SELECT ROUND((COUNT(p.exp_internet)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS BAJO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
              ...
              $sqlmmmm = "SELECT ROUND((COUNT(p.exp_internet)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS MEDIO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
              ...
              $sqlmmmmm = "SELECT ROUND((COUNT(p.exp_internet)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS ALTO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
              ...
              $sqlmmmmmm = "SELECT ROUND((COUNT(p.exp_internet)/(SELECT COUNT(*) FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
                WHERE r.id_proyecto = ".$_REQUEST['id']."
                AND r.id_proyecto = r1.id_proyecto
                AND r1.url_secreta = p.url
                AND p.def = 'Si'))*100,2) AS MUY_ALTO FROM respuestas_smil r, rec r1, presentacion_usuario p, proyecto p1
      ...
      Plotly.newPlot('myDi', data, layout, config);
        ...
        <?php
            ...
            $sqqql = "SELECT COUNT(r.valor_aprendizaje) AS COUNT FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";
            ...
            $sqql = "SELECT AVG(r.valor_atraccion) AS ATRACCION FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registroq = mysqli_query($connect, $sqql) or die(mysqli_error($connect));
            $row = mysqli_fetch_array($registroq);
            $media_atraccion = $row['ATRACCION'];

            //MEDIA DE LA MUESTRA P1,...,PN
            $sqql = "SELECT AVG(r.valor_facilidad) AS FACILIDAD FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registroq = mysqli_query($connect, $sqql) or die(mysqli_error($connect));
            $row = mysqli_fetch_array($registroq);
            $media_facilidad = $row['FACILIDAD'];

            //MEDIA DE LA MUESTRA P1,...,PN
            $sqql = "SELECT AVG(r.valor_aprendizaje) AS APRENDIZAJE FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";
            ...
            //MEDIA DE LA MUESTRA P1,...,PN
            $sqql = "SELECT AVG(r.valor_entretenimiento) AS ENTRETENIMIENTO FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registroq = mysqli_query($connect, $sqql) or die(mysqli_error($connect));
            $row = mysqli_fetch_array($registroq);
            $media_entretenimiento = $row['ENTRETENIMIENTO'];

            //DATOS P1,...,PN
            $sql = "SELECT r.valor_atraccion FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registro = mysqli_query($connect, $sql) or die(mysqli_error($connect));
            
            while ($fila_atraccion = mysqli_fetch_assoc($registro)){
                $nuevo_array_atraccion[] = $fila_atraccion;
            }

            //DATOS P1,...,PN
            $sql = "SELECT r.valor_facilidad FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registro = mysqli_query($connect, $sql) or die(mysqli_error($connect));
            
            while ($fila_facilidad = mysqli_fetch_assoc($registro)){
                $nuevo_array_facilidad[] = $fila_facilidad;
            }

            //DATOS P1,...,PN
            $sql = "SELECT r.valor_aprendizaje FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";
            ...
            //DATOS P1,...,PN
            $sql = "SELECT r.valor_entretenimiento FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registro = mysqli_query($connect, $sql) or die(mysqli_error($connect));
            
            while ($fila_entretenimiento = mysqli_fetch_assoc($registro)){
                $nuevo_array_entretenimiento[] = $fila_entretenimiento;
            }
          ...
          */
          if ($count <= 30){
              $desv_tip_atraccion = 0;
              $desv_tip_facilidad = 0;
              $desv_tip_aprendizaje = 0;
              $desv_tip_entretenimiento = 0;

              for ($i = 0; $i < $count; $i++) {
                  $desv_tip_atraccion = $desv_tip_atraccion + pow(($nuevo_array_atraccion[$i]['valor_atraccion'] - $media_atraccion),2);
                  $desv_tip_facilidad = $desv_tip_facilidad + pow(($nuevo_array_facilidad[$i]['valor_facilidad'] - $media_facilidad),2);
                  $desv_tip_aprendizaje = $desv_tip_aprendizaje + pow(($nuevo_array_aprendizaje[$i]['valor_aprendizaje'] - $media_aprendizaje),2);
                  $desv_tip_entretenimiento = $desv_tip_entretenimiento + pow(($nuevo_array_entretenimiento[$i]['valor_entretenimiento'] - $media_entretenimiento),2);
              }

              $resultado_atraccion = $desv_tip_atraccion / ($count); //es muestral
              $final_atraccion = sqrt($resultado_atraccion);

              $resultado_facilidad = $desv_tip_facilidad / ($count); //es muestral
              $final_facilidad = sqrt($resultado_facilidad);
              $resultado_aprendizaje = $desv_tip_aprendizaje / ($count); //es muestral
              $final_aprendizaje = sqrt($resultado_aprendizaje);

              $resultado_entretenimiento = $desv_tip_entretenimiento / ($count); //es muestral
              $final_entretenimiento = sqrt($resultado_entretenimiento);
              ...
              $t_final = $row['T_FINAL'];
              //echo $count;
              $intervalo_atraccion = (($t_final * $final_atraccion) / sqrt($count));
              $intervalo_facilidad = (($t_final * $final_facilidad) / sqrt($count));
              $intervalo_aprendizaje = (($t_final * $final_aprendizaje) / sqrt($count));
              $intervalo_entretenimiento = (($t_final * $final_entretenimiento) / sqrt($count));
             ...
             // T=1,96
              $intervalo_atraccion = ((1.96 * $final_atraccion) / sqrt($count));
              $intervalo_facilidad = ((1.96 * $final_facilidad) / sqrt($count));
              $intervalo_aprendizaje = ((1.96 * $final_aprendizaje) / sqrt($count));
              $intervalo_entretenimiento = ((1.96 * $final_entretenimiento) / sqrt($count));
          }
...
<script type="text/javascript">
      var trace2 = {
        x: ['Atracción', 'Facilidad', 'Aprendizaje', 'Entretenimiento' ],
        y: ['<?php echo $media_atraccion ?>','<?php echo $media_facilidad ?>','<?php echo $media_aprendizaje ?>','<?php echo $media_entretenimiento ?>'],
        name: 'Experimental',
        error_y: {
          type: 'data',
          array: ['<?php echo $intervalo_atraccion; ?>', '<?php echo $intervalo_facilidad; ?>', '<?php echo $intervalo_aprendizaje; ?>', '<?php echo $intervalo_entretenimiento; ?>'],
          visible: true
        },
        type: 'bar'
      };
...
<?php
            ...
            $sql = "SELECT r.valor_atraccion AS ATRACCION FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registro = mysqli_query($connect, $sql) or die(mysqli_error($connect));

            $valor_atraccion=array(); 

            while($row = mysqli_fetch_array($registro)){
                  $valor_atraccion[] = $row['ATRACCION'];
            };
          
            //echo "<pre>";
            //print_r($valor_efi);
            
            $valor_atraccion=json_encode($valor_atraccion);

            $sql = "SELECT r.valor_facilidad AS FACILIDAD FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registro = mysqli_query($connect, $sql) or die(mysqli_error($connect));

            $valor_facilidad=array(); 

            while($row = mysqli_fetch_array($registro)){
                  $valor_facilidad[] = $row['FACILIDAD'];
            };
          
            //echo "<pre>";
            //print_r($valor_afec);
            
            $valor_facilidad=json_encode($valor_facilidad);

            $sql = "SELECT r.valor_aprendizaje AS APRENDIZAJE FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registro = mysqli_query($connect, $sql) or die(mysqli_error($connect));

            $valor_aprendizaje=array(); 

            while($row = mysqli_fetch_array($registro)){
                  $valor_aprendizaje[] = $row['APRENDIZAJE'];
            };
          
            //echo "<pre>";
            //print_r($valor_ayu);
            
            $valor_aprendizaje=json_encode($valor_aprendizaje);

            $sql = "SELECT r.valor_entretenimiento AS ENTR FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";

            $registro = mysqli_query($connect, $sql) or die(mysqli_error($connect));

            $valor_entretenimiento=array(); 

            while($row = mysqli_fetch_array($registro)){
                  $valor_entretenimiento[] = $row['ENTR'];
            };
          
            //echo "<pre>";
            //print_r($valor_ctr);
            
            $valor_entretenimiento=json_encode($valor_entretenimiento);
...
<script type="text/javascript">
    valor_atraccion = crearCadenaLineal('<?php echo $valor_atraccion; ?>');
    valor_facilidad = crearCadenaLineal('<?php echo $valor_facilidad; ?>');
    valor_aprendizaje = crearCadenaLineal('<?php echo $valor_aprendizaje; ?>');
    valor_entretenimiento = crearCadenaLineal('<?php echo $valor_entretenimiento; ?>');


var xData = ['Atracción', 'Facilidad',
       ...
       <h5><strong>Datos descriptivos: </strong></h5>
        <ul>
          <li>Tamaño de la muestra: <?php 
            ...
            //     WHERE r.id_proyecto = 1
            //     AND r.id_proyecto = r1.id_proyecto) p;
            $sql = "SELECT DISTINCT COUNT(r.puntuacion_final) AS NUM_PART FROM respuestas_smil r, rec r1 WHERE r.id_proyecto = ".$_REQUEST['id']." AND r.id_proyecto = r1.id_proyecto ";
        ...
        <li>Máximo: <?php 
            ...
            $sql = "SELECT ROUND(MAX(r.puntuacion_final),2) AS NUM_PART FROM respuestas_smil r, rec r1 WHERE r.id_proyecto = ".$_REQUEST['id']." AND r.id_proyecto = r1.id_proyecto";
        ...
        <li>Mínimo: <?php 
            ...
            $sql = "SELECT ROUND(MIN(r.puntuacion_final),2) AS NUM_PART FROM respuestas_smil r, rec r1 WHERE r.id_proyecto = ".$_REQUEST['id']." AND r.id_proyecto = r1.id_proyecto";
        ...
        <li>Desviación estándar poblacional <?php echo "(σ)" ?>: <?php
            $connect = mysqli_connect("localhost", "root", "", "blog");
            //TAMAÑO DE LA MUESTRA (N) -> numero usuarios
            $sqqql = "SELECT COUNT(r.puntuacion_final) AS COUNT FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";
            ...
            $count = $rwow['COUNT'];
            //MEDIA DE LA MUESTRA
            $sqql = "SELECT AVG(r.puntuacion_final) AS MEDIA FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";
            ...
            $media = $row['MEDIA'];
            //DATOS AGRUPADOS.
            $sql = "SELECT r.puntuacion_final FROM respuestas_smil r
            WHERE r.id_proyecto = ".$_REQUEST['id']."";
  ...
  <?php
    if ($countt > 5){
      ...
      <?php
            ...
            $sql = "SELECT r.valor_facilidad, r.puntuacion_final FROM respuestas_smil r
...
@media only screen and (max-width: 768px) {
    ...
    $(document).ready(function() {
        ...
        table.buttons().container()
    .appendTo( $('#example5 .col-sm-6:eq(0)', table.table().container() ) );
    });
    </script>
