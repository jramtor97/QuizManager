...
<span onclick="window.location.href='<?php echo SERVIDOR ?>';" class="w3-bar-item w3-button w3-hide-large w3-hover-none w3-hover-text-light-grey">QuizManager</span>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>  Gestión de Proyectos</a>
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>  Mis proyectos</a>
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bullseye fa-fw"></i>  Gestión de cuestionarios</a>
