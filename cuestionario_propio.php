...
<html lang="en">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <br>
              <button type="button" class="btn btn-primary" onclick="registrarRes()"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Enviar cuestionario</a>
          </div>
        </div>
        <br>
      </div>
  ...
  <script type="text/javascript">
    ...
    function registrarRes(){
      ...
      $.ajax({
            type: "POST",
            url: "ajax_respuestas_quiz_propio.php",
            data: {
            ...
            success: function (data) { 
                window.location.href='estadistica_propia.php?url=<?php echo $_REQUEST['url']; ?>'+'&u=<?php echo $_REQUEST['u']; ?>'+'&id_quiz=<?php echo $_REQUEST['id_quiz']; ?>&p=1';
                //alert(data);
            }
        });
          ...
          <div class="col-md-12">
            <div class="form-group">
                ...
                for ($y = 0; $y <= $cont_consultaa -1; $y++){
                  ...
                  <input type="text" class="form-control" id="titulo_resp<?php echo $cont; ?>" placeholder="Respuesta pregunta <?php echo $cont; ?>">
                  <br>
                </div>
                  <?php } ?>
                  <?php } ?>
