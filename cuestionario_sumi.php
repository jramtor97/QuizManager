...
@media only screen and (max-width: 768px) {
   ...
   <div class="container" style="background-color: #ffffff; padding: 20px; margin: auto; "> 
    ...
    <div class="container">
     ...
     <form action="/action_page.php">
        ...
        <form action="/action_page.php">
            <tr><td>23</td>
                <td>Puedo entender correctamente la información proporcionada por este sistema</td>
  ...
  <script type="text/javascript">
    ...
    function registrarResultado(){
        ...
        if (isNaN(p1) && isNaN(p2) && isNaN(p3) && isNaN(p4) && isNaN(p5) && isNaN(p6) && isNaN(p7) && isNaN(p8) && isNaN(p9) && isNaN(p10) && isNaN(p11) && isNaN(p12) && isNaN(p13) && isNaN(p14) && isNaN(p15) && isNaN(p16) && isNaN(p17) && isNaN(p18) && isNaN(p19) && isNaN(p20) && isNaN(p21) && isNaN(p22) && isNaN(p23) && isNaN(p24) && isNaN(p25) && isNaN(p26) && isNaN(p27) && isNaN(p28) && isNaN(p29) && isNaN(p30) && isNaN(p31) && isNaN(p32) && isNaN(p33) && isNaN(p34) && isNaN(p35) && isNaN(p36) && isNaN(p37) && isNaN(p38) && isNaN(p39) && isNaN(p40) && isNaN(p41) && isNaN(p42) && isNaN(p43) && isNaN(p44) && isNaN(p45) && isNaN(p46) && isNaN(p47) && isNaN(p48) && isNaN(p49) && isNaN(p50) && uso == '' && aspecto == '' && importancia == null) {
        ...
        } else if (isNaN(p1) || isNaN(p2) || isNaN(p3) || isNaN(p4) || isNaN(p5) || isNaN(p6) || isNaN(p7) || isNaN(p8) || isNaN(p9) || isNaN(p10) || isNaN(p11) || isNaN(p12) || isNaN(p13) || isNaN(p14) || isNaN(p15) || isNaN(p16) || isNaN(p17) || isNaN(p18) || isNaN(p19) || isNaN(p20) || isNaN(p21) || isNaN(p22) || isNaN(p23) || isNaN(p24) || isNaN(p25) || isNaN(p26) || isNaN(p27) || isNaN(p28) || isNaN(p29) || isNaN(p30) || isNaN(p31) || isNaN(p32) || isNaN(p33) || isNaN(p34) || isNaN(p35) || isNaN(p36) || isNaN(p37) || isNaN(p38) || isNaN(p39) || isNaN(p40) || isNaN(p41) || isNaN(p42) || isNaN(p43) || isNaN(p44) || isNaN(p45) || isNaN(p46) || isNaN(p47) || isNaN(p48) || isNaN(p49) || isNaN(p50) || uso == '' || aspecto == '' || importancia == null) {
            swal ( "¡Error! Cuestionario no enviado" ,  "Debes completar todas las preguntas" ,  "error" );
        ...
        valor_aprendizaje = (((p5 + p10 + p15 + p20 + p25 + p30 + p35 + p40 + p45 + p50)/10)/3)*100;
