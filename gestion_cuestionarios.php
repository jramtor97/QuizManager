...
<html lang="en">
   ...
   <div class="container">
    ...
    <div id="h" class="container">
      <style>
        .h {
          ...
          <button type="button" id="nuevo_proy" class="btn btn-primary pull-right menu" onclick="location.href='crear-cuestionario.php'" ><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Nuevo cuestionario
    </div>
    ...
    $(document).ready(function() { 
        ...
        var x = $('#example').DataTable({
            ...
            responsive: true,
            ajax: "ajax_listar_cuestionario.php",
            language: {
  ...
  <script type="text/javascript">
    function eliminarQuiz(id){
        $.ajax({
            type: "POST",
            url: "ajax_borrar_cuestionario.php",
            data: {
                id : id
            },
